...
void main() {
  group('LocalePersistenceService', () {
    ...
    test('getPreferredLocale should return null when no locale is set',
        () async {
      final locale = await localePersistenceService.getPreferredLocale();
      expect(locale, isNull);
    });

    test('getPreferredLocale should return Locale when locale is set',
        () async {
    ...
    test('savePreferredLocale should save the locale to SharedPreferences',
        () async {
